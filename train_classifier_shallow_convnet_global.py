...
def train(X_train, y_train, X_val, y_val, subject):
    ...
    def layers(inputs):
        ...
        pipe = Conv3D(40, (1,42), strides=(1,1,1), padding='valid')(inputs)
...
def evaluate_model(X_test, y_test, subject, crops):
    ...
    model = load_model('./model_results_global/{}.hdf5'.format(model_name))
    ...
    out_df.to_csv('./model_results_global/{}.csv'.format(model_name))
