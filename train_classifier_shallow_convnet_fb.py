...
def train(X_train, y_train, X_val, y_val, subject):
    ...
    def layers(inputs):
        ...
        pipe1 = Conv3D(48, (1,3,3), strides=(1,1,1), padding='valid')(inputs)
        pipe1 = Conv3D(48, (1,3,3), strides=(1,1,1), padding='valid')(pipe1)
        ...
        pipe12 = Conv3D(40, (1,2,3), strides=(1,1,1), padding='valid')(pipe12)
